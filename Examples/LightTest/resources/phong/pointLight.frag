...
void main() 
{
    ...
    for (int l = 0; l < LIGHT_COUNT; ++l)
    {
        ...
        colorDiffuse += light.lights[l].color * colorTextureDiffuse * diffuseIntensive;
        ...
        if (diffuseIntensive > 0.01)
        {
            ...
            colorSpecular += colorTextureSpecular * pow(max(dot(r, viewDir), 0.01), specPower) * attenuation;
        }
    }
