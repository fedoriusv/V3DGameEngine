...
{
    cmd.setViewport(core::Rect32(0, 0, m_offsceenRenderTarget->getDimension().width, m_offsceenRenderTarget->getDimension().height));
    cmd.setScissor(core::Rect32(0, 0, m_offsceenRenderTarget->getDimension().width, m_offsceenRenderTarget->getDimension().height));

    cmd.setRenderTarget(m_offsceenRenderTarget);
    {
        cmd.setPipelineState(m_sponzaMRTPipeline);
