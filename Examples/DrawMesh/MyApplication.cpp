    ...
    , m_Render(nullptr)
{
    ...
    m_Camera = new CameraArcballHelper(new Camera(core::Vector3D(0.0f, 0.0f, 0.0f), core::Vector3D(0.0f, -1.0f, 0.0f)), 5.0f, 4.0f, 20.0f);
...
void MyApplication::Initialize()
{
    ...
    Shader* vertShader = resource::ResourceLoaderManager::getInstance()->loadShader<Shader, resource::ShaderSourceFileLoader>(m_CommandList->getContext(), "shaders/mesh.vert", {}, ShaderSource_OptimisationPerformance);
    Shader* fragShader = resource::ResourceLoaderManager::getInstance()->loadShader<Shader, resource::ShaderSourceFileLoader>(m_CommandList->getContext(), "shaders/mesh.frag", {}, ShaderSource_OptimisationPerformance);
    //Shader* vertShader = resource::ResourceLoaderManager::getInstance()->loadShader<Shader, resource::ShaderBinaryFileLoader>(m_CommandList->getContext(), "shaders/mesh.vspv", {});
    //Shader* fragShader = resource::ResourceLoaderManager::getInstance()->loadShader<Shader, resource::ShaderBinaryFileLoader>(m_CommandList->getContext(), "shaders/mesh.fspv", {});
...
#endif
    Model* model = resource::ResourceLoaderManager::getInstance()->load<Model, resource::ModelFileLoader>("models/voyager/voyager.dae");
