...
std::string getLiteralString(u32 word, u32& byteSize)
{
...
PatchDriverBugOptimisation::PatchDriverBugOptimisation(u32 flags) noexcept
    : m_flags(flags)
{
}

bool PatchDriverBugOptimisation::patch(std::vector<u32>& spirv, u32 flags)
{
    ...
    std::tuple<bool, TypeVector<4>> vectorBoolType(false, {}); //TODO
...
bool PatchDriverBugOptimisation::composePatch(std::function<bool(std::vector<u32>& subSpirv)> func, std::vector<u32>& spirv)
{
    return func(spirv);
}
