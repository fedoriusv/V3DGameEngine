...
Mesh* MeshHelper::createStaticMesh(renderer::Device* device, renderer::CmdListRender* cmdList, resource::MeshResource* resource)
{
    ...
    {
        renderer::IndexBuffer* indexBuffer = V3D_NEW(renderer::IndexBuffer, memory::MemoryLabel::MemoryObject)(device, renderer::Buffer_Write, resource->getIndexBufferType(), resource->getIndexBufferCount(), "IndexBuffer");
    ...
    {
        renderer::VertexBuffer* vertexBuffer = V3D_NEW(renderer::VertexBuffer, memory::MemoryLabel::MemoryObject)(device, renderer::BufferUsage::Buffer_Write, resource->getVertexBufferCount(), resource->getVertexBufferSize(), "VertexBuffer");
