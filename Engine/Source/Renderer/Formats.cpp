...
namespace renderer
{
    ...
    const u32 k_formatList[Format::Format_Count][2] = 
    {
        ...
        /* Format_BC1_RGB_UNorm_Block = 131*/               { 3, 64 },
        /* Format_BC1_RGB_SRGB_Block = 132*/                { 3, 64 },
        /* Format_BC1_RGBA_UNorm_Block = 133*/              { 4, 64 },
        /* Format_BC1_RGBA_SRGB_Block = 134*/               { 4, 64 },
        /* Format_BC2_UNorm_Block = 135*/                   { 4, 128 },
        /* Format_BC2_SRGB_Block = 136*/                    { 4, 128 },
        /* Format_BC3_UNorm_Block = 137*/                   { 4, 128 },
        /* Format_BC3_SRGB_Block = 138*/                    { 4, 128 },
        /* Format_BC4_UNorm_Block = 139*/                   { 1, 64 },
        /* Format_BC4_SNorm_Block = 140*/                   { 1, 64 },
        /* Format_BC5_UNorm_Block = 141*/                   { 2, 128 },
        /* Format_BC5_SNorm_Block = 142*/                   { 2, 128 },
        /* Format_BC6H_UFloat_Block = 143*/                 { 3, 128 },
        /* Format_BC6H_SFloat_Block = 144*/                 { 3, 128 },
        /* Format_BC7_UNorm_Block = 145*/                   { 4, 128 },
        /* Format_BC7_SRGB_Block = 146*/                    { 4, 128 },
