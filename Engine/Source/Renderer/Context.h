...
namespace renderer
{
    ...
    */
    ...
    public:
        ...
        virtual Image* createImage(TextureTarget target, Format format, const core::Dimension3D& dimension, TextureSamples samples, TextureUsageFlags flags, [[maybe_unused]] const std::string& name = "") = 0;
