...
namespace math
{
    ...
    template<class T>
    constexpr inline TVector4D<T>::TVector4D() noexcept
        : _x(0)
        , _y(0)
        , _z(0)
        , _w(0)
    ...
    template<class T>
    constexpr inline TVector4D<T>::TVector4D(T n) noexcept
        : _x(n)
        , _y(n)
        , _z(n)
        , _w(n)
    ...
    template<class T>
    constexpr inline TVector4D<T>::TVector4D(T x, T y, T z, T w) noexcept
        : _x(x)
        , _y(y)
        , _z(z)
        , _w(w)
    ...
    template<class T>
    constexpr inline TVector4D<T>::TVector4D(const TVector4D<T>& other) noexcept
        : _x(other._x)
        , _y(other._y)
        , _z(other._z)
        , _w(other._w)
    ...
    template<class T>
    constexpr inline TVector4D<T>::TVector4D(const TVector3D<T>& other, T w) noexcept
        : _x(other._x)
        , _y(other._y)
        , _z(other._z)
        , _w(w)
